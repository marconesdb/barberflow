      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        <div className="space-y-6">
          ...
          <p className="text-sm leading-relaxed">
            Elevando o conceito de barbearia com precisão, estilo e um atendimento exclusivo para quem não abre mão da excelência.
          </p>
  ...
  <div className="space-y-32">
    ...
    <section className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
      <div className="space-y-8 relative z-10">
        ...
        >
          <Star className="w-3 h-3 fill-zinc-900" /> A Melhor Experiência de SP
        </motion.div>
        ...
        >
          Não é apenas um corte. É um ritual de cuidado e confiança. 
          Agende agora e descubra o padrão BarberFlow.
        </motion.p>
        ...
        <div className="flex items-center gap-6 pt-8">
          ...
          <div className="text-sm">
            <div className="flex items-center gap-1 text-zinc-900 font-bold">
              <Star className="w-4 h-4 fill-zinc-900" /> 4.9/5
            </div>
      ...
      >
        ...
        <img 
          src="https://picsum.photos/seed/barber/800/1000" 
          className="relative rounded-[32px] shadow-2xl w-full aspect-[4/5] object-cover grayscale hover:grayscale-0 transition-all duration-700" 
          alt="Barber Shop" 
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div 
              key={i}
              whileHover={{ y: -10 }}
              className="bg-white/5 border border-white/10 p-10 rounded-[32px] backdrop-blur-sm group hover:bg-white/10 transition-all"
            >
              <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-white group-hover:text-zinc-900 transition-all">
                {service.icon}
              </div>
    ...
    <section className="max-w-7xl mx-auto px-6 py-20">
      <div className="grid lg:grid-cols-2 gap-20 items-center">
        <div className="grid grid-cols-2 gap-4">
          <img src="https://picsum.photos/seed/shop1/400/600" className="rounded-3xl w-full aspect-[3/4] object-cover mt-12" alt="Shop" referrerPolicy="no-referrer" />
          <img src="https://picsum.photos/seed/shop2/400/600" className="rounded-3xl w-full aspect-[3/4] object-cover" alt="Shop" referrerPolicy="no-referrer" />
        </div>
        <div className="space-y-8">
          ...
          <p className="text-lg text-zinc-600 leading-relaxed">
            ...
            Nosso ambiente foi projetado para ser o seu refúgio diário, onde o bom café e a boa conversa são garantidos.
          </p>
    ...
    <section className="max-w-7xl mx-auto px-6 pb-32">
      <div className="bg-zinc-950 rounded-[48px] p-12 md:p-24 text-center space-y-10 relative overflow-hidden">
        ...
        <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
          Não deixe para depois. Garanta seu horário agora mesmo através do nosso sistema online.
        </p>
